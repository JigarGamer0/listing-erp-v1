...
<div class="fade-in" x-data="{ activeTab: 'overview', showAssignModal: false, showDeleteModal: false, showDeductModal: false }" @open-assign-modal.window="showAssignModal = true">
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($employee->name); ?></h2>
                    <div class="flex items-center space-x-3 mt-1 text-sm text-gray-500">
                        <span>📱 <?php echo e($employee->phone ?? '—'); ?></span>
                        <span>Role: <?php echo e($employee->role_title ?? 'Employee'); ?></span>
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($employee->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>"><?php echo e(ucfirst($employee->status)); ?></span>
                    </div>
                </div>
            </div>
            <div class="flex flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('employees.edit', $employee)); ?>" class="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white text-sm font-medium rounded-xl transition-all">✏️ Edit</a>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
                ...
                <p class="text-lg font-bold text-gray-800 dark:text-white"><?php echo e($employee->total_clients); ?></p>
            </div>
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
                <p class="text-xs text-gray-500">Fixed Salary</p>
                <p class="text-lg font-bold text-gray-800 dark:text-white">₹<?php echo e(number_format($employee->fixed_salary, 0)); ?></p>
            </div>
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
                <p class="text-xs text-gray-500">Pending Comm.</p>
                <p class="text-lg font-bold text-amber-600">₹<?php echo e(number_format($employee->total_pending_commission, 0)); ?></p>
            </div>
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
                <p class="text-xs text-gray-500">Advance</p>
                <p class="text-lg font-bold text-red-600">₹<?php echo e(number_format($employee->total_pending_advance, 0)); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $clientCommissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="py-3 flex justify-between items-center">
                                    <div>
                                        <p class="text-sm font-medium text-gray-800 dark:text-white"><?php echo e($item['client']->name); ?></p>
                                        <p class="text-xs text-gray-500">
                                            Package: ₹<?php echo e(number_format($item['client']->current_package, 0)); ?>

                                            · Start: <?php echo e($item['client']->service_start_date ? $item['client']->service_start_date->format('d/m/Y') : '—'); ?>

                                            · Assigned: <?php echo e($item['assignment']->assigned_date ? $item['assignment']->assigned_date->format('d/m/Y') : '—'); ?>

                                            <?php if($item['assignment']->gst_count > 0): ?>
                                                 · GST: <?php echo e($item['assignment']->gst_count); ?> <?php echo e($item['assignment']->gst_platform ? '(' . ucfirst($item['assignment']->gst_platform) . ')' : ''); ?>

                                            <?php endif; ?>
                                        </p>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        <span class="text-sm font-semibold text-gray-800 dark:text-white">₹<?php echo e(number_format($item['commission_amount'], 0)); ?></span>
                                        <form method="POST" action="<?php echo e(route('employees.unassign-client', [$employee, $item['assignment']])); ?>">
                                            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                            <div class="flex justify-between border-b pb-2"><span>Joining Date</span><span class="font-medium text-gray-800 dark:text-white"><?php echo e($employee->joining_date->format('d/m/Y')); ?></span></div>
                            <div class="flex justify-between border-b pb-2"><span>Salary Type</span><span class="font-medium text-gray-800 dark:text-white"><?php echo e(ucfirst(str_replace('_', ' ', $employee->salary_type))); ?></span></div>
                            <div class="flex justify-between border-b pb-2"><span>Commission Type</span><span class="font-medium text-gray-800 dark:text-white"><?php echo e(ucfirst(str_replace('_', ' ', $employee->commission_type))); ?></span></div>
                            <div class="flex justify-between border-b pb-2"><span>Commission Value</span><span class="font-medium text-gray-800 dark:text-white"><?php echo e($employee->commission_type === 'percentage' ? $employee->commission_value . '%' : '₹' . number_format($employee->commission_value, 0)); ?></span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'salaries'">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('salary.history', ['employee_id' => $employee->id])); ?>" class="text-xs text-blue-600 hover:underline font-medium">View Full History Archive →</a>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm">
                            <?php $__empty_1 = true; $__currentLoopData = $employee->salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30">
                                    <td class="px-4 py-3 font-semibold text-gray-800 dark:text-white"><?php echo e($salary->month_name ?? \Carbon\Carbon::create($salary->year, $salary->month, 1)->format('F Y')); ?></td>
                                    <td class="px-4 py-3 text-right">₹<?php echo e(number_format($salary->base_salary, 2)); ?></td>
                                    <td class="px-4 py-3 text-right text-emerald-600 font-medium">+₹<?php echo e(number_format($salary->total_commission, 2)); ?></td>
                                    <td class="px-4 py-3 text-right text-red-500 font-medium">-₹<?php echo e(number_format($salary->advance_deduction, 2)); ?></td>
                                    <td class="px-4 py-3 text-right font-bold text-gray-900 dark:text-white">₹<?php echo e(number_format($salary->net_payable, 2)); ?></td>
                                    <td class="px-4 py-3 text-right font-bold text-emerald-600">₹<?php echo e(number_format($salary->paid_amount, 2)); ?></td>
                                    <td class="px-4 py-3 text-center">
                                        <span class="inline-block text-xs font-medium px-2.5 py-0.5 rounded-full <?php echo e($salary->status === 'paid' ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400'); ?>">
                                            <?php echo e(ucfirst($salary->status)); ?>

                                        </span>
                                    </td>
                                    <td class="px-4 py-3 text-center text-xs text-gray-500"><?php echo e($salary->paid_date ? $salary->paid_date->format('d/m/Y') : '—'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
            ...
            <div x-show="activeTab === 'advances'">
                ...
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $employee->advances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl flex justify-between items-center">
                            <div>
                                <p class="font-semibold text-gray-800 dark:text-white">₹<?php echo e(number_format($adv->amount, 0)); ?></p>
                                <p class="text-xs text-gray-500">Date: <?php echo e($adv->advance_date->format('d/m/Y')); ?> · Remaining: ₹<?php echo e(number_format($adv->remaining, 0)); ?></p>
                            </div>
                            <span class="inline-block text-xs font-medium px-2 py-0.5 rounded-full <?php echo e($adv->status === 'fully_deducted' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $adv->status))); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div x-show="activeTab === 'deductions'">
                ...
                <div class="overflow-x-auto rounded-xl border border-gray-100 dark:border-gray-700">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm">
                            <?php $__empty_1 = true; $__currentLoopData = $employee->salaryDeductions->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30">
                                    <td class="px-4 py-3 font-semibold text-gray-800 dark:text-white">
                                        <?php echo e(\Carbon\Carbon::create($deduction->year, $deduction->month, 1)->format('F Y')); ?>
                                    ...
                                    <td class="px-4 py-3 text-xs text-gray-500">
                                        <?php echo e($deduction->createdByUser?->name ?? 'Admin'); ?>

                                    </td>
                                    <td class="px-4 py-3 text-xs text-gray-400">
                                        <?php echo e($deduction->created_at ? $deduction->created_at->format('d/m/Y h:i A') : '—'); ?>

                                    </td>
                                    <td class="px-4 py-3 text-center">
                                        <form method="POST" action="<?php echo e(route('salary.deductions.destroy', $deduction)); ?>" onsubmit="return confirm('Cancel this ₹<?php echo e(number_format($deduction->amount, 0)); ?> salary deduction and restore to employee salary?');">
                                            <?php echo csrf_field(); ?>
    ...
    <div x-show="showAssignModal"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 max-w-lg w-full mx-4 shadow-xl relative"
            ...
            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">Assign Client to <?php echo e($employee->name); ?></h3>
            
            <form method="POST" action="<?php echo e(route('employees.assign-client', $employee)); ?>">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="client_id" required id="modal_client_id" class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-800 dark:text-white outline-none">
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($client->id); ?>" data-package="<?php echo e($client->current_package); ?>"><?php echo e($client->name); ?> (Package: ₹<?php echo e(number_format($client->current_package, 0)); ?>)</option>
    ...
    <div x-show="showDeleteModal" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 max-w-md w-full mx-4 shadow-2xl relative"
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">
                Are you sure you want to delete employee <strong class="text-gray-900 dark:text-white"><?php echo e($employee->name); ?></strong>?
            </p>
            ...
            <form action="<?php echo e(route('employees.destroy', $employee)); ?>" method="POST" class="flex justify-end space-x-3">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
    ...
    <div x-show="showDeductModal" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 max-w-md w-full mx-4 shadow-2xl relative"
            ...
            <form method="POST" action="<?php echo e(route('salary.deductions.store', $employee)); ?>">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div class="p-3.5 bg-rose-50/50 dark:bg-rose-950/30 rounded-xl border border-rose-100/60 dark:border-rose-900/30">
                        <p class="text-xs text-gray-500">Employee: <span class="font-bold text-gray-900 dark:text-white"><?php echo e($employee->name); ?></span></p>
                        <p class="text-xs text-gray-500 mt-0.5">Applied to: <span class="font-bold text-gray-800 dark:text-white"><?php echo e(date('F Y')); ?></span> (Current month only)</p>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jigar\OneDrive\Documents\.l\Listing website v1\resources\views/employees/show.blade.php ENDPATH**/ ?>